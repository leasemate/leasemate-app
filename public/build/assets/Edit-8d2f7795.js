...
`;U(Z);y.render=G;var q=(()=>{const e=y;return e.install=o=>{o.component("VueBasicAlert",e)},e})();const J={class:"card"},K={class:"p-4 sm:p-8"},O={class:"card"},Q={class:"p-4 sm:p-8"},R={class:"card"},W={class:"p-4 sm:p-8"},le={__name:"Edit",props:{mustVerifyEmail:{type:Boolean},status:{type:String}},setup(e){const o=T(null);return(l,n)=>(i(),a(z,null,[s(m(S),{title:"Profile"}),s(b,null,{header:f(()=>[B(" Profile ")]),default:f(()=>[t("div",J,[t("div",K,[s($,{"must-verify-email":e.mustVerifyEmail,status:e.status,class:"max-w-xl"},null,8,["must-verify-email","status"])])]),t("div",O,[t("div",Q,[s(x,{class:"max-w-xl"})])]),t("div",R,[t("div",W,[s(k,{class:"max-w-xl"})])]),s(m(q),{duration:300,onClose:r=>!0,ref_key:"alert",ref:o},null,512)]),_:1})],64))}};export{le as default};
