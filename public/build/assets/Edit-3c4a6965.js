...
`;Z(G);w.render=U;var J=(()=>{const e=w;return e.install=t=>{t.component("VueBasicAlert",e)},e})();const K={class:"p-4 sm:p-8 bg-white shadow sm:rounded-lg"},O={class:"p-4 sm:p-8 bg-white shadow sm:rounded-lg"},Q={class:"p-4 sm:p-8 bg-white shadow sm:rounded-lg"},re={__name:"Edit",props:{mustVerifyEmail:{type:Boolean},status:{type:String}},setup(e){const t=C(null);return(l,n)=>(i(),a(T,null,[s(m(S),{title:"Profile"}),s(b,null,{header:f(()=>[B(" Profile ")]),default:f(()=>[o("div",K,[s($,{"must-verify-email":e.mustVerifyEmail,status:e.status,class:"max-w-xl"},null,8,["must-verify-email","status"])]),o("div",O,[s(x,{class:"max-w-xl"})]),o("div",Q,[s(k,{class:"max-w-xl"})]),s(m(J),{duration:300,onClose:r=>!0,ref_key:"alert",ref:t},null,512)]),_:1})],64))}};export{re as default};
