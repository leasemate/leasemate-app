...
export function fileStatusClass() {
    ...
    const status_classes = {
        ...
        'STATUS_CLASSES': {
            ...
            'Queued': 'bg-yellow-50 text-yellow-600 ring-yellow-400/20',
            'Warning': 'bg-yellow-50 text-yellow-600 ring-yellow-400/20',
            ...
            'Deleted': 'bg-red-50 text-red-800 ring-slate-600/20',
            'Archived': 'bg-slate-100 text-slate-400 ring-slate-500/20',
        },
        'PROCESS_CLASSES': {
            'Pending': 'bg-gray-400',
