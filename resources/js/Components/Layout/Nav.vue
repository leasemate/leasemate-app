        ...
        <simplebar data-simplebar class="h-full">
            ...
            <div
                ...
                <ul class="metismenu" id="side-menu">
                    ...
                    <li>
<!--                        <Link :href="route('chats.index')" class="pl-6 pr-4 py-3 block text-sm font-medium text-gray-700 ease-linear hover:text-violet-500 hover:bg-indigo-50 dark:hover:bg-gray-700 dark:text-gray-300 dark:active:text-white dark:hover:text-white">-->
