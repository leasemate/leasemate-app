...
<!--                            </li>-->
<!--                            <li>-->
<!--                                <a :href="route('file-upload.create')" class="pl-14 pr-4 py-2 block text-[13.5px] font-medium text-gray-700 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">Upload</a>-->
<!--                            </li>-->
