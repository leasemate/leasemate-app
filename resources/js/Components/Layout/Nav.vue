...
<template>
    ...
    <div
        class="vertical-menu rtl:right-0 fixed ltr:left-0 bottom-0 top-16 h-screen border-r bg-indigo-50 border-gray-50 print:hidden dark:bg-zinc-800 dark:border-neutral-700 z-10">

        <TenantTitle v-if="!showIcon" />

        <simplebar class="h-full" data-simplebar>
            <!--- Sidemenu -->
            <div
                ...
                <ul id="side-menu" class="metismenu">
                    ...
                    <li>
                        <a class="nav-menu pl-6 pr-4 py-3 block text-sm font-medium text-gray-700 ease-linear hover:text-indigo-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white"
