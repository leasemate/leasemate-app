                ...
                <div class="max-w-screen-2xl mx-auto">
                    ...
                    <div class="mt-6 mb-6">
                        ...
                        <div v-if="$page.props.flash.success"
                             class="relative px-5 py-3 border-2 bg-green-50 text-green-700 border-green-100 rounded-lg">
                            <p>{{ $page.props.flash.success }}</p>
                        </div>

                        <div v-if="$page.props.flash.error"
                             class="relative px-5 py-3 border-2 bg-red-50 text-red-700 border-red-100 rounded-lg">
                            <p>{{ $page.props.flash.error }}</p>
                        </div>

                        <div v-if="$page.props.flash.message"
                             class="relative px-5 py-3 border-2 bg-yellow-50 text-yellow-700 border-yellow-100 rounded-lg">
